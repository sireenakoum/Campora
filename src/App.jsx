  ...
  return (
      <div className="layout">
        <aside className="sidebar">
          {/* Logo Section */}
          <div style={{ display: 'flex', alignItems: 'center', gap: '12px', background: 'white', padding: '12px', margin: '0 20px 40px 20px', borderRadius: '16px', border: '1px solid rgba(224, 229, 242, 0.8)', boxShadow: '0 10px 25px -5px rgba(11, 26, 63, 0.12)', transition: 'all 0.3s ease' }}>
          ...
          <nav style={{ flex: 1 }}>
            ...
            {/* RESTORED NOTIFICATIONS LINK */}
            <NavLink to="/notifications" className={({isActive}) => isActive ? "nav-item active" : "nav-item"}><Bell size={20}/> Notifications</NavLink>
          ...
          <Link to="/profile" style={{ padding: '25px', borderTop: '1px solid #eee', textDecoration: 'none', display: 'block' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
              ...
              <div>
                <p style={{ fontWeight: '900', fontSize: '14px', color: '#0B1A3F', margin: 0 }}>{userName || 'Lara'}</p>
